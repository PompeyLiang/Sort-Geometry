...
This is a python component that sort input breps based on breps' center points in X axis  

Compent name: Sort Brep in X
Input Parameter:
...
def sort_list_object(list):
  ...
  __msg__: Sort one index list based on point.X list; and then access breps list with sorted index list. 
  __paras__: 
        geometry: Breps that needed to sorted in X Axis. 
  __return__: 
