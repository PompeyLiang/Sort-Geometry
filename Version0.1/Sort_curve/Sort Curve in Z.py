...
def sort_list_object(list):
  ...
  __msg__: Sort one index list based on point.Z list; and then access curves list with sorted index list. 
  __paras__: 
        geometry: Curves that needed to sorted in Z Axis. 
  __return__: 
